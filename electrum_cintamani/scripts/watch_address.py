...
from electrum_cintamani.util import print_msg, create_and_start_event_loop
from electrum_cintamani.synchronizer import SynchronizerBase
...
try:
    ...
    print("usage: watch_address <cintamani_address>")
    sys.exit(1)
