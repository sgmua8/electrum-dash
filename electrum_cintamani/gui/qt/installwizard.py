...
from electrum_cintamani.util import UserCancelled, InvalidPassword, WalletFileException, get_new_wallet_name
from electrum_cintamani.base_wizard import (BaseWizard, HWD_SETUP_DECRYPT_WALLET,
...
from electrum_cintamani.plugin import run_hook, Plugins
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config: 'SimpleConfig', app: QApplication, plugins: 'Plugins', *, gui_object: 'ElectrumGui'):
        ...
        self.set_icon('electrum-cintamani.png')
        self.show()
        self.raise_()
