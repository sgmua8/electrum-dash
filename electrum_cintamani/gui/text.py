...
from electrum_cintamani.network import NetworkParameters, TxBroadcastError, BestEffortRequestFailed
from electrum_cintamani.interface import ServerAddr
    ...
    def network_dialog(self):
        ...
        if out:
            ...
            if out.get('server') or out.get('proxy'):
                proxy = electrum_cintamani.network.deserialize_proxy(out.get('proxy')) if out.get('proxy') else proxy_config
