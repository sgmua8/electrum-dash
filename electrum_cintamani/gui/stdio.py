...
from electrum_cintamani import WalletStorage, Wallet
from electrum_cintamani.wallet_db import WalletDB
from electrum_cintamani.util import format_satoshis
from electrum_cintamani.bitcoin import is_address, COIN
from electrum_cintamani.transaction import PartialTxOutput
from electrum_cintamani.network import TxBroadcastError, BestEffortRequestFailed
from electrum_cintamani.cintamani_ps_util import filter_log_line, PSLogSubCat
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electrum-cintamani create'")
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-cintamani setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-cintamani setconfig' to change your settings")
        return True
