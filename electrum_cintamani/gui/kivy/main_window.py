...
from electrum_cintamani.cintamani_ps_util import (PSPossibleDoubleSpendError,
                                        PSSpendToPSAddressesError)
from electrum_cintamani.storage import WalletStorage, StorageReadWriteError
from electrum_cintamani.wallet_db import WalletDB
from electrum_cintamani.wallet import Wallet, InternalAddressCorruption, Abstract_Wallet
from electrum_cintamani.wallet import update_password_for_directory

from electrum_cintamani.plugin import run_hook
from electrum_cintamani import util
from electrum_cintamani.util import (profiler, InvalidPassword, send_exception_to_crash_reporter,
                           format_satoshis, format_satoshis_plain, format_fee_satoshis)
from electrum_cintamani.invoices import PR_PAID, PR_FAILED
from electrum_cintamani import blockchain
from electrum_cintamani.network import Network, TxBroadcastError, BestEffortRequestFailed
from electrum_cintamani.interface import PREFERRED_NETWORK_PROTOCOL, ServerAddr
from electrum_cintamani.logging import Logger

from electrum_cintamani.gui import messages
from .i18n import _
...
#Factory.register('InstallWizard', module='electrum_cintamani.gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_cintamani.gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_cintamani.gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_cintamani.gui.kivy.uix.dialogs')
...
from .uix.dialogs.cintamani_kivy import TorWarnDialog
...
# the data
Cache.register('electrum_cintamani_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_cintamani.gui.kivy.uix.screens')
...
from electrum_cintamani.util import (NoDynamicFeeEstimates, NotEnoughFunds,
...
if TYPE_CHECKING:
    ...
    from electrum_cintamani.paymentrequest import PaymentRequest
...
class ElectrumWindow(App, Logger):
    ...
    def __init__(self, **kwargs):
        ...
        self._cintamani_net_dialog = None
    ...
    def on_qr(self, data: str):
        from electrum_cintamani.bitcoin import is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from electrum_cintamani.transaction import tx_from_any
        try:
            tx = tx_from_any(data)
        except:
            tx = None
    ...
    def scan_qr(self, on_complete):
        ...
        PythonActivity = autoclass('org.kivy.android.PythonActivity')
        SimpleScannerActivity = autoclass("org.cintamani.electrum.qr.SimpleScannerActivity")
        Intent = autoclass('android.content.Intent')
    ...
    def on_start(self):
        ...
        # bind intent for cintamani: URI scheme
        if platform == 'android':
            from android import activity
            from jnius import autoclass
            PythonActivity = autoclass('org.kivy.android.PythonActivity')
    ...
    def cintamani_net_dialog(self):
        from .uix.dialogs.cintamani_net import DashNetDialog
        if self._cintamani_net_dialog is None:
            self._cintamani_net_dialog = DashNetDialog(self)
        self._cintamani_net_dialog.update()
        self._cintamani_net_dialog.open()
    ...
    def popup_dialog(self, name):
        if name == 'settings':
            ...
            self.plugins_dialog()
        elif name == 'cintamani_net':
            self.cintamani_net_dialog()
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_cintamani.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_cintamani.gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_cintamani_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_cintamani_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        if self.testnet:
            self.icon = os.path.dirname(KIVY_GUI_PATH) + "/icons/electrum-cintamani-testnet.png"
        else:
            self.icon = os.path.dirname(KIVY_GUI_PATH) + "/icons/electrum-cintamani.png"
    ...
    def get_max_amount(self, is_ps=False):
        from electrum_cintamani.transaction import PartialTxOutput
