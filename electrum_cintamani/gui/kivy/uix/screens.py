...
from electrum_cintamani.invoices import (PR_TYPE_ONCHAIN, PR_DEFAULT_EXPIRATION_WHEN_CREATING,
                                    PR_PAID, PR_UNKNOWN, PR_EXPIRED, PR_INFLIGHT,
                                    pr_expiration_values, Invoice, OnchainInvoice,
                                    InvoiceExt)
from electrum_cintamani import bitcoin, constants
from electrum_cintamani.transaction import tx_from_any, PartialTxOutput
from electrum_cintamani.util import (parse_URI, InvalidBitcoinURI, TxMinedInfo,
...
from electrum_cintamani.gui.kivy import KIVY_GUI_PATH
from electrum_cintamani.gui.kivy.i18n import _

if TYPE_CHECKING:
    from electrum_cintamani.gui.kivy.main_window import ElectrumWindow
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_cintamani.util import create_bip21_uri
        amount = self.amount
        if amount:
