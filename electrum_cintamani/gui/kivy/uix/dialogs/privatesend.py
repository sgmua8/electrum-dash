...
from electrum_cintamani.cintamani_ps_util import (filter_log_line, PSLogSubCat, PSStates,
                                        PS_DENOMS_VALS)
...
#:import SpinBox electrum_cintamani.gui.kivy.uix.spinbox.SpinBox
...
<EXWarnPopup@Popup>
    ...
    BoxLayout:
        ...
        orientation: 'vertical'
        Image:
            source:'atlas://electrum_cintamani/gui/kivy/theming/atlas/light/error'
            size_hint_y: 0.1
        Label:
            size_hint_y: 0.4
            id: warn_msg
