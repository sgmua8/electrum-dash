...
from electrum_cintamani.util import UserCancelled
from electrum_cintamani.keystore import bip39_normalize_passphrase
from electrum_cintamani.bip32 import BIP32Node, convert_bip32_path_to_list_of_uint32
from electrum_cintamani.logging import Logger
from electrum_cintamani.plugin import runs_in_hwd_thread
from electrum_cintamani.plugins.hw_wallet.plugin import HardwareClientBase, HardwareHandlerBase
...
class KeepKeyClientBase(HardwareClientBase, GuiMixin, Logger):
    ...
    def has_usable_connection_with_device(self):
        try:
            res = self.ping("electrum-cintamani pinging device")
            assert res == "electrum-cintamani pinging device"
