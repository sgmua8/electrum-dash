...
from electrum_cintamani.crypto import hash_160
from electrum_cintamani.bitcoin import (int_to_hex, var_int, b58_address_to_hash160,
...
from electrum_cintamani.transaction import Transaction, PartialTransaction, PartialTxInput, PartialTxOutput
from electrum_cintamani.wallet import Standard_Wallet
from electrum_cintamani.util import bfh, bh2u, versiontuple, UserFacingException
from electrum_cintamani.base_wizard import ScriptTypeNotSupported
from electrum_cintamani.logging import get_logger
from electrum_cintamani.plugin import runs_in_hwd_thread, Device
...
try:
    ...
    BTCHIP = False
    btchip = object  # to test whithout btchip modules (see btchip_cintamani class)
...
class Ledger_Client(HardwareClientBase):
    def __init__(self, hidDevice, *, product_key: Tuple[int, int],
        ...
        self.dongleObject = btchip_cintamani(hidDevice)
