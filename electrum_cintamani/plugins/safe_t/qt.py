...
from electrum_cintamani.gui.qt.util import (WindowModalDialog, WWLabel, Buttons, CancelButton,
                                       OkButton, CloseButton, getOpenFileName)
from electrum_cintamani.i18n import _
from electrum_cintamani.plugin import hook
from electrum_cintamani.util import bh2u
    ...
    def request_safe_t_init_settings(self, wizard, method, device):
        ...
        if method in [TIM_NEW, TIM_RECOVER]:
            ...
            if method == TIM_MNEMONIC:
                ...
                def set_enabled():
                    from electrum_cintamani.bip32 import is_xprv
