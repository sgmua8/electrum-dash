...
from electrum_cintamani import cintamani_ps, ecc
from electrum_cintamani.address_synchronizer import (TX_HEIGHT_LOCAL,
                                                TX_HEIGHT_UNCONF_PARENT,
                                                TX_HEIGHT_UNCONFIRMED)
from electrum_cintamani.bitcoin import COIN
from electrum_cintamani.cintamani_ps_util import (COLLATERAL_VAL, CREATE_COLLATERAL_VAL,
                                        ...
                                        MixingStats)
from electrum_cintamani.cintamani_ps_wallet import (KPStates, KP_ALL_TYPES, KP_SPENDABLE,
                                          KP_PS_COINS, KP_PS_CHANGE,
                                          PSKsInternalAddressCorruption)
from electrum_cintamani.cintamani_tx import PSTxTypes, SPEC_TX_NAMES
from electrum_cintamani import keystore
from electrum_cintamani.simple_config import SimpleConfig
from electrum_cintamani.storage import WalletStorage
from electrum_cintamani.transaction import (Transaction, PartialTxOutput,
                                       PartialTransaction)
from electrum_cintamani.util import Satoshis, NotEnoughFunds, TxMinedInfo, bh2u
...
class PSWalletTestCase(TestCaseForTestnet):
    ...
    def test_calc_need_denoms_amounts_on_keep_amount(self):
        w = self.wallet
        psman = w.psman
        two_cintamani_amnts_val = 200142001

        res = psman.calc_need_denoms_amounts()
        assert sum([sum(amnts)for amnts in res]) == two_cintamani_amnts_val
