...
from electrum_cintamani.bitcoin import (public_key_to_p2pkh, address_from_private_key,
...
from electrum_cintamani import bip32
from electrum_cintamani.bip32 import (BIP32Node, convert_bip32_intpath_to_strpath,
                                 xpub_from_xprv, xpub_type, is_xprv, is_bip32_derivation,
                                 is_xpub, convert_bip32_path_to_list_of_uint32,
                                 normalize_bip32_derivation, is_all_public_derivation)
from electrum_cintamani.crypto import sha256d, SUPPORTED_PW_HASH_VERSIONS
from electrum_cintamani import ecc, crypto, constants
from electrum_cintamani.util import bfh, bh2u, InvalidPassword, randrange
from electrum_cintamani.storage import WalletStorage
from electrum_cintamani.keystore import xtype_from_derivation, from_master_key

from electrum_cintamani import ecc_fast
...
class Test_xprv_xpub(ElectrumTestCase):
    ...
    def test_is_xkey_consistent_with_key_origin_info(self):
        ...
        self.assertTrue(bip32.is_xkey_consistent_with_key_origin_info(
            "xprvA1ajNXSjB5Hyr6Ymi4CZN1L4YrPvZsWi9gtGLQ7naV4ooteTC5EMu33m8zpcm1bcWmpZtCt3gsEiFe1KXSzVMuLGryga89oPmYVAj9nA5Jc",
            derivation_prefix="m/44'/1'/0'/2'",
            root_fingerprint="083f40c8"))
        # ok to skip args
        self.assertTrue(bip32.is_xkey_consistent_with_key_origin_info(
            "xprvA1ajNXSjB5Hyr6Ymi4CZN1L4YrPvZsWi9gtGLQ7naV4ooteTC5EMu33m8zpcm1bcWmpZtCt3gsEiFe1KXSzVMuLGryga89oPmYVAj9nA5Jc",
            derivation_prefix="m/44'/1'/0'/2'"))
        ...
        self.assertFalse(bip32.is_xkey_consistent_with_key_origin_info(
            "xprvA1ajNXSjB5Hyr6Ymi4CZN1L4YrPvZsWi9gtGLQ7naV4ooteTC5EMu33m8zpcm1bcWmpZtCt3gsEiFe1KXSzVMuLGryga89oPmYVAj9nA5Jc",
            derivation_prefix="m/44'/0'/2'",
            root_fingerprint="083f40c8"))
        # path changed: wrong child index
        self.assertFalse(bip32.is_xkey_consistent_with_key_origin_info(
            "xprvA1ajNXSjB5Hyr6Ymi4CZN1L4YrPvZsWi9gtGLQ7naV4ooteTC5EMu33m8zpcm1bcWmpZtCt3gsEiFe1KXSzVMuLGryga89oPmYVAj9nA5Jc",
            derivation_prefix="m/44'/1'/0'/3'",
            root_fingerprint="083f40c8"))
        # path changed: but cannot tell
        self.assertTrue(bip32.is_xkey_consistent_with_key_origin_info(
            "xprvA1ajNXSjB5Hyr6Ymi4CZN1L4YrPvZsWi9gtGLQ7naV4ooteTC5EMu33m8zpcm1bcWmpZtCt3gsEiFe1KXSzVMuLGryga89oPmYVAj9nA5Jc",
            derivation_prefix="m/44'/1'/1'/2'",
            root_fingerprint="083f40c8"))
        ...
        self.assertTrue(bip32.is_xkey_consistent_with_key_origin_info(
            "xprv9vcSAkyeXwGTAEAS1HsoZYLM11tqK39EyjjhsZLF3bmMUotCoYhH3NXsfKGovssbT77aewSHLAMNQA4rNJsrupxnmZWL4yXvUSCGExLxPiE",
            derivation_prefix="m/0'",
            root_fingerprint="e8e6faa5"))
        # path changed: wrong depth
        self.assertFalse(bip32.is_xkey_consistent_with_key_origin_info(
            "xprv9vcSAkyeXwGTAEAS1HsoZYLM11tqK39EyjjhsZLF3bmMUotCoYhH3NXsfKGovssbT77aewSHLAMNQA4rNJsrupxnmZWL4yXvUSCGExLxPiE",
...
class Test_drk_import(ElectrumTestCase):
...
class Test_keyImport(ElectrumTestCase):
    ...
    def test_is_address_bad_checksums(self):
        self.assertTrue(is_address('XhgzhL7rvJQV4MzRuis6btAyyDAhoMcGoA'))
        self.assertFalse(is_address('1819s5TxxbBtuRPr3qYskMVC8sb1pqapWw'))

        self.assertTrue(is_address('7maNAh4xVptDJRKzT2brX42iePPFbFGKfz'))
