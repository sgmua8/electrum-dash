...
from electrum_cintamani.util import (format_satoshis, format_fee_satoshis, parse_URI,
...
class TestUtil(ElectrumTestCase):
    ...
    def test_parse_URI_invalid_address(self):
        self.assertRaises(BaseException, parse_URI, 'cintamani:invalidaddress')

    def test_parse_URI_invalid(self):
        self.assertRaises(BaseException, parse_URI, 'notcintamani:XfTA9qgYmaEHfWhUakwcoTtyquez8SowY1')

    def test_parse_URI_parameter_polution(self):
        self.assertRaises(Exception, parse_URI, 'cintamani:XfTA9qgYmaEHfWhUakwcoTtyquez8SowY1?amount=0.0003&label=test&amount=30.0')
