...
VERSION_STRING=(`grep ELECTRUM_VERSION electrum_cintamani/version.py`)
DASH_ELECTRUM_VERSION=${VERSION_STRING[2]}
DASH_ELECTRUM_VERSION=${DASH_ELECTRUM_VERSION#\'}
DASH_ELECTRUM_VERSION=${DASH_ELECTRUM_VERSION%\'}
export DASH_ELECTRUM_VERSION

APK_VERSION_STRING=(`grep APK_VERSION electrum_cintamani/version.py`)
...
APK_VERSION_CODE_SCRIPT='./contrib/cintamani/travis/calc_version_code.py'
